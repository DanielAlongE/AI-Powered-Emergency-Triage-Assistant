...
class HandbookRagOpenAiAgent(BaseTriageAgent):
    ...
    def _build_prompt(self, transcript: str, red_flag_terms: List[str], rag_context: str) -> str:
        ...
        instructions = [
            ...
            "• Level 2 (High risk): High-risk presentation, severe pain/distress, or danger signs even if stable",
            "• Level 3 (Moderate): Stable, needs 2 or more resources (labs, imaging, IV meds, consults)",
